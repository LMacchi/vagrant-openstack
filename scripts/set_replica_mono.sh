...
sudo /opt/puppetlabs/puppet/bin/puppet infrastructure enable -y --topology mono \
  --agent-server-urls lb.lmacchi.vm:8140,replica.lmacchi.vm:8140 \
  ...
  --infra-pcp-brokers master.lmacchi.vm:4433,replica.lmacchi.vm:4433 \
